...
def sim_tanimoto(prefs, person1, person2):
    # Tum filmlerin oldugu bir liste olustur
    all_items = []
    for person in prefs:
...
def sim_cosine(prefs, person1, person2):
    ...
    # Ortak fimleri bulmak yerine butun filmleri ayni sirayla da alabilirdiniz 
